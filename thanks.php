...
<head>
    ...
    <img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=<?=@$_SESSION['pixel']?>&ev=Lead&noscript=1">
    <script>
...
<body>
    ...
    <section class="thanks">
        <div class="thanks__container container">
            ...
            <div class="thanks__bottom">
                ...
                <form method="post" action="" class="thanks__bottom-wrap" id="subscribe-form" style="display: none">
    ...
    <script>
        ...
        if (formSubscribe) {
            formSubscribe.addEventListener('submit', (e) => {
                e.preventDefault();
                const form = e.target,
                    subscribeInput = form.querySelector('input');
                ...
                if (isValidEmail(subscribeInput.value)) {
                    fetch('write.php', {
                        ...
                        document.getElementById('subscribe-form-sended').style.display = 'flex';
                        setCookie('emailSubmitted', 'true', 1);  // Запись в cookie, что отзыв отправлен
                    })
                } else {
                    subscribeInput.classList.add('error');
                    subscribeInput.addEventListener('input', () => {
                        if (isValidEmail(subscribeInput.value)) subscribeInput.classList.remove('error')
                    })
                }
            })
        }
    ...
    <script>
        ...
        if(endDateEl) {
            ...
            endDateEl.innerText = moment().add(9, 'days').format('LL');
        }
    </script>
